...
cat > pointwise.mask.properties  << EOF1
...
sampling.outfile=samples/pointwise/samples_mask.txt

#size of a chunk
maskingsampler.chunksize=10
#Probability that this chunk is visible
maskingsampler.visprob=0.25

EOF1

mvn exec:java@point -Dexec.args="pointwise.mask.properties"

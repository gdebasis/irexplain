...
public class TRECQueryParser extends DefaultHandler {
    ...
    public TRECQueryParser(String fileName, Analyzer analyzer, String contentFieldName) throws SAXException {
    ...
    public Query constructLuceneQueryObj(TRECQuery trecQuery) throws QueryNodeException {        
        Query luceneQuery = queryParser.parse(trecQuery.title, contentFieldName);
        return luceneQuery;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            TRECQueryParser parser = new TRECQueryParser(queryFile, new EnglishAnalyzer(), "words");
            parser.parse();
